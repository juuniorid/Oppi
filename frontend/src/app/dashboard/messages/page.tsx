          ...
          {chats.map((chat) => (
            <div
              ...
              className={`p-4 rounded-2xl mb-2 cursor-pointer transition-all ${
                chat.active ? 'bg-[#F9E79F]/30' : 'hover:bg-gray-50'
              }`}
            >
      ...
      <Card className="flex-1 border-none shadow-sm rounded-[2.5rem] bg-white flex flex-col overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex gap-3 bg-gray-50 p-2 rounded-2xl border border-gray-100">
            ...
            />
            <Button className="bg-gray-900 text-white p-3 rounded-xl hover:bg-black transition-all h-10 w-10 flex items-center justify-center">
